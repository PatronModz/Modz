...
class Settings:
    ...
    def edit_tag_from_chat(self, msg: str) -> None:
        error = lambda: bui.getsound('error').play()
        apply = lambda: bui.getsound('dingSmall').play()
...
def new_chatmsg(msg, *args) -> None:
    chatmsg(msg, *args)
    stg.edit_tag_from_chat(msg)
