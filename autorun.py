...
class AutoRun(bs.Plugin):
    ...
    bascenev1lib.actor.spaz.Spaz.__init__ = new_init(bascenev1lib.actor.spaz.Spaz.__init__)
    ...
    def new_updown(func):
        ...
        return wrapper
    # You get the idea.
    bascenev1lib.actor.spaz.Spaz.on_move_up_down = new_updown(bascenev1lib.actor.spaz.Spaz.on_move_up_down)
    ...
    def new_leftright(func):
        def wrapper(*args, **kwargs):
            ...
            if not args[0].autorun_override and args[0].source_player:
                AutoRun.run_update(args[0])
        return wrapper
    bascenev1lib.actor.spaz.Spaz.on_move_left_right = new_leftright(bascenev1lib.actor.spaz.Spaz.on_move_left_right)
