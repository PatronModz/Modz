    ...
    def _set_cloud_mods(self) -> None:
        ...
        for mod in self._cmods:
            ...
            b = bui.buttonwidget(parent=c,
                     ...
                     size=(70,70),button_type='square',color=(1,0,0),
                     label='',on_activate_call=bs.Call(self.download_plugin, mod))
